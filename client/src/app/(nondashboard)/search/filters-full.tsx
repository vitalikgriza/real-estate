...
import { cn, formatEnumString, updateSearchParams } from "@/lib/utils";
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div>
          ...
          <Slider
            ...
            step={100}
            value={[
              localFilters.squareFeetRange[0] ?? 0,
              localFilters.squareFeetRange[1] ?? 5000,
            ]}
            onValueChange={(value) =>
              setLocalFilters((prev) => ({
                ...prev,
                squareFeetRange: value as [number, number],
              }))
            }
          />
          <div className="flex justify-between mt-2">
            <span>{localFilters.squareFeetRange[0] ?? 0} sq ft</span>
            <span>{localFilters.squareFeetRange[1] ?? 5000} sq ft</span>
          </div>
        </div>
